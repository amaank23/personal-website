...
const SkillsSection = () => {
  return (
    <section className="section flex flex-col justify-center about py-36">
      <div className="flex gap-16 border-t border-white pt-10 mx-4 md:mx-[3.75rem] flex-col">
        <div className="">
          <h2 className="text-[2.8125rem] 2xl:text-[4.375rem] font-bold about-heading text-[#FF5925] text-center md:text-left">
            Skills
          </h2>
        </div>
        <div className="flex flex-col gap-8 justify-center w-full lg:items-center">
