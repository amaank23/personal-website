...
const AboutSection = () => {
  ...
  return (
    <section
      className="section flex flex-col justify-center about py-36"
      id="about"
    >
      <div className="flex flex-col gap-16 pt-10 mx-[1rem] md:mx-[3.75rem]">
        ...
        <div className="flex justify-center w-full">
          <p
            className="text-white text-[16px] sm:text-[1.625rem] 2xl:text-[38px] max-w-[1100px] about-desc font-bold text-center"
            style={{
